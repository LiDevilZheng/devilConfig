...
<title>APP开发者平台</title>
	...
	<!--绝对路径 <link href="${pageContext.request.contextPath}/statics/css/bootstrap.min.css" rel="stylesheet"> -->
	...
	<script type="text/javascript" src="../../appMannage/statics/js/jquery.min.js"></script>
</head>
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> APP应用管理<span
									...
									<ul class="nav child_menu">
										<li><a href="appinfolist.html">APP维护</a>
										</li>
									</ul></li>
							</ul>
						</div>
